...
const subcategories = [
    'Перезагрузка роутера / порта / ONU',
    'Плохо подключённый кабель',
    'Отсутствие MAC-адреса',
    'Оплата произведена, но интернет не работает',
    'Проблема с клонированием MAC-адреса',
    'Низкая скорость интернета',
    'Однодиапазонный роутер',
    'Нестабильная работа на отдельных приложениях или сайтах',
    'Слишком много подключённых устройств',
    'Нет сигнала / Обрыв кабеля',
    'Каналы не настроены',
    'Отсутствуют ТВ-каналы',
    'Поиск частоты',
    'Проблема с HDMI-AV адаптером',
    'Сброс настроек',
    'Выбран неправильный режим входа / источника сигнала',
    'Изменение имени сети Wi-Fi (SSID) или пароля',
    'Неправильная настройка роутера (неверный SSID/пароль)',
    'Потеря сигнала на определённом расстоянии от роутера',
    'Сеть не отображается в списке доступных',
    'Сброс настроек роутера',
    'Установка и настройка нового роутера',
    'Изменение пароля администратора',
    'Продление подписки',
    'Некоторые каналы заблокированы (нет подписки)',
    'Оплата произведена, но телевидение не работает'
];
